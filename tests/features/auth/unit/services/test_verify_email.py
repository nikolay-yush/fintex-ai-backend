...
class TestVerifyEmail:
    ...
    async def test_verify_email_success(self):
        ...
        verification_token.id = 1
        verification_token.user_id = 10
        ...
        verification_token_repo.get_verification_token.return_value = (
            verification_token
        )
        ...
        verification_token_repo.get_verification_token.assert_awaited_once_with(
            "verification-token",
        )
    ...
    async def test_verify_email_token_not_found(self):
        ...
        verification_token_repo.get_verification_token.return_value = None

        # Act / Assert
        with pytest.raises(EmailVerificationTokenNotFoundException):
    ...
    async def test_verify_email_token_expired(self):
        ...
        # Act / Assert
        with pytest.raises(EmailVerificationTokenExpiredException):
